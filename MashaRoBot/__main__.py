...
༒︎ 𝐈 𝐀𝐦 𝐌𝐮𝐥𝐭𝐢 𝐓𝐚𝐥𝐞𝐧𝐭𝐞𝐝 𝐁𝐨𝐭 𝐖𝐢𝐭𝐡 𝐎𝐬𝐦 𝐅𝐞𝐚𝐭𝐮𝐫𝐞

➪ 𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 𝐀𝐧𝐝 𝐌𝐚𝐤𝐞 𝐀𝐝𝐦𝐢𝐧 𝐓𝐨 𝐌𝐚𝐧𝐚𝐠𝐞 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 𝐖𝐢𝐭𝐡 𝐄𝐱𝐩𝐥𝐨𝐬𝐢𝐯𝐞

➪ 𝐂𝐥𝐢𝐜𝐤 𝐁𝐞𝐥𝐨𝐰 𝐁𝐮𝐭𝐭𝐨𝐧 𝐇𝐞𝐥𝐩 𝐓𝐨 𝐄𝐱𝐩𝐥𝐨𝐫𝐞 𝐌𝐨𝐫𝐞 𝐌𝐲 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬.
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *✰𝐍𝐨𝐛𝐢𝐬𝐮𝐤𝐢✰*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Nobisuki's licensed under the GNU General Public License v3.0_
                 \n\nIf you have any question about Nobisuki, let us know at @NobisukiSupport.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I am Back to online!", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
