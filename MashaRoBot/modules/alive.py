...
BUTTON = [[Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/NobisukiSupport"), Button.url("ᴜᴘᴅᴀᴛᴇs", "https://t.me/Koyuki_Updates")]]
...
async def hmm(yes):
    ...
    pm_caption = "** ♡ I,m Serena **\n\n"
    pm_caption += f"**♡ My Uptime :** `{uptime}`\n\n"
    pm_caption += f"**♡ Telethon Version :** `{version.__version__}`\n\n"
    pm_caption += "**♡ My Master :** [Crazy Boy](https://t.me/call_me_crazyboy)\n"
    BUTTON = [[Button.url("Support", "https://t.me/NobisukiSupport"), Button.url("Updates", "https://t.me/Koyuki_Updates")]]
