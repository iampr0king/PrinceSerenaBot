...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} உங்கள் உண்மையான பெயர் என்ன?",
    ...
    "{first} நீங்கள் அதிக முறை பாத்த திரைப்படம் எது👀",
    ...
    "நீங்கள் பார்த்த கஷ்டங்கள் யாருக்கும் தெரியாது 🥺",
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "{first} குலத்தை விட்டு வெளியேறிவிட்டார்",
    "{first} விளையாட்டை விட்டு வெளியேறிவிட்டார்",
    ...
    "போட எச்ச பயலே 🥶💦",
    "விரைவில் உங்களை மீண்டும் பார்ப்போம் என்று நம்புகிறோம், {first}",
    ...
    "தயவுசெய்து என்னை இந்த இடத்தில் தனியாக விட்டுவிடாதீர்கள், {first}!",
